...
def get_features(model, dataloader, max_images=10 ** 10, verbose=False):
    ...
    for index, (img, label) in enumerate(dataloader):
        ...
        # handle0 = model.layer1[2].register_forward_hook(get_features_hook0)
        # handle1 = model.layer2[3].register_forward_hook(get_features_hook1)
        # handle2 = model.layer3[5].register_forward_hook(get_features_hook2)
...
def main():
    ...
    print("labes are:", labels_train.size)
    # np.save("./features_all/supervised_cifar100/1st_block.npy", Feature1_train)
    # np.save("./features_all/supervised_cifar100/2nd_block.npy", Feature2_train)
    # np.save("./features_all/supervised_cifar100/3rd_block.npy", Feature3_train)

    np.save("./features_all/supervised_cifar100/features_train2_model2.npy",features_train)
    np.save("./features_all/supervised_cifar100/labels_train2_model2.npy",labels_train)
    # ------------------------------------------    


    # # ---- get features from id test data-----
    # features_test, labels_test = get_features(model.encoder, test_loader)
    # np.save("./features_all/supervised_cifar100/features_test_model2.npy",features_test)
    ...
    # # np.save("./features_all/supervised_cifar100/test_1st_block.npy", Feature1_test)
    # # np.save("./features_all/supervised_cifar100/test_2nd_block.npy", Feature2_test)
    # # np.save("./features_all/supervised_cifar100/test_3rd_block.npy", Feature3_test)
    # np.save("./features_all/supervised_cifar100/labels_test_model2.npy", labels_test)
    # # ----------------------------------
    ...
    for d in ds:
        ...
        # # ----- get features from ood data  -------
        # features_ood, labels_ood = get_features(model.encoder, ood_loader)
        # np.save("./features_all/supervised_cifar100/features_ood_model2.npy",features_ood)
        ...
        # # np.save("./features_all/supervised_cifar100/ood_1st_block.npy", Feature1_ood)
        # # np.save("./features_all/supervised_cifar100/ood_2nd_block.npy", Feature2_ood)
        # # np.save("./features_all/supervised_cifar100/ood_3rd_block.npy", Feature3_ood)
        # np.save("./features_all/supervised_cifar100/labels_ood_model2.npy", labels_ood)
        # # -------------------------
